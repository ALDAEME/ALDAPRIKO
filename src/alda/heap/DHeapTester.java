...
//				assertEquals(a, b);
	 ...
	 * som skapar en vanlig binär heap, och en som tar ett argument: d.
	 * Observera att detta betyder att ni måste förändra de konstruktorer som
	 * finns i ursprungskoden eftersom det redan finns en konstruktor som tar
	 * ett heltalsargument.
	 * 
	 * Den tredje konstruktorn i orginalversionen får ni göra som ni vill med,
	 * den är inte viktig för uppgiften, så plocka bort den om ni inte absolut
	 * vill fixa den också.
	 */
	@Test
	public void testConstructors() {
		heap = new DHeap<Integer>(); // Skapar en binärheap
		heap = new DHeap<Integer>(2); // Skapar ytterligare en binärheap
	 ...
	 * ut index för en nods förälder. Detta är inte nödvändigt för att lösa
	 ...
	 * första barnets index och kan ignorerars om ni inte gör det.
	 */
	@Test(expected = IllegalArgumentException.class)
	 ...
	 * funnits i orginalet. get däremot bryter inkapslingen ganska rejält och är
	 * bara till för att vi ska kunna testa. Det är naturligtvis förkastligt,
